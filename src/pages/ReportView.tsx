...
function ReportContent({ reportEntry }: { reportEntry: ReportEntry }) {
  ...
  const description = `Análisis de ${reportEntry.category} — ${reportEntry.title}. Fuente: ${data.meta.source}.`;

  return (
    <>
      <Helmet>
        <title>{reportEntry.title} · Dashboard Luján de Cuyo</title>
        <meta name="description" content={description} />
        <meta property="og:title" content={`${reportEntry.title} · Dashboard Luján de Cuyo`} />
        <meta property="og:description" content={description} />
        <meta property="og:type" content="article" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`${reportEntry.title} · Dashboard Luján de Cuyo`} />
                ...
                <div>
                  <h1
                    ...
                    style={{
                      ...
                      background: `linear-gradient(135deg, ${reportEntry.color}, #ec4899)`,
